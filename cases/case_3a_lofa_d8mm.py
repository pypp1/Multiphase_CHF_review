...
Quasi-static G sweep: 1500 → 300 kg/(m²·s) at constant heat flux.
...
DESCRIPTION = (
    ...
    "Mass flux decreases from nominal to 300 kg/(m²·s); heat flux is held constant.  "
...
P_PA     = 7.0e6 # Pa
X_IN     = -0.041
Q_NOM_MW = 1.1   # MW/m²  (held constant)

# ── LOFA sweep parameters ─────────────────────────────────────────────────────
G_START  = 1500.0  # kg/(m²·s)  initial mass flux
G_END    = 300.0   # kg/(m²·s)  final mass flux
G_STEP   = -50.0   # kg/(m²·s)  step size (negative = decreasing)
